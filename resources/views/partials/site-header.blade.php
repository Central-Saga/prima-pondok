<header class="sticky top-0 z-40 bg-white/80 backdrop-blur border-b">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <nav class="flex items-center gap-4">
            <a href="{{ route('home') }}#kamar" class="text-slate-600 hover:text-slate-900">Kamar</a>
            <a href="{{ route('home') }}#fasilitas" class="text-slate-600 hover:text-slate-900">Fasilitas</a>
            <a href="{{ route('home') }}#galeri" class="text-slate-600 hover:text-slate-900">Galeri</a>
            <a href="{{ route('home') }}#kontak" class="text-slate-600 hover:text-slate-900">Kontak</a>
            @auth
                @role('admin')
