...
<section <?php echo e($attributes->merge(['class' => 'py-16 bg-slate-900 text-white scroll-mt-24'])); ?>>
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid gap-8 sm:grid-cols-2">
        <div>
            <h2 class="text-2xl sm:text-3xl font-semibold"><?php echo e($title); ?></h2>
            <div class="mt-4 space-y-3 text-slate-200">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <a href="tel:<?php echo e(preg_replace('/[^0-9+]/','', $phone)); ?>" class="text-white underline underline-offset-2 decoration-white/30 hover:decoration-white"><?php echo e($phone); ?></a>
                </div>
                <div class="flex items-center gap-3">
                    ...
                    <a href="mailto:<?php echo e($email); ?>" class="text-white underline underline-offset-2 decoration-white/30 hover:decoration-white"><?php echo e($email); ?></a>
                </div>
            </div>
            <div class="mt-6">
                <a href="https://wa.me/<?php echo e($wa); ?>" class="inline-flex items-center gap-2 rounded-md bg-white/10 px-4 py-2 text-sm font-medium hover:bg-white/20">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                      <path stroke-linecap="round" stroke-linejoin="round" d="M12 20.25c4.97 0 9-3.694 9-8.25s-4.03-8.25-9-8.25S3 7.444 3 12c0 2.104.859 4.023 2.273 5.48.432.447.74 1.04.586 1.641a4.483 4.483 0 0 1-.923 1.785A5.969 5.969 0 0 0 6 21c1.282 0 2.47-.402 3.445-1.087.81.22 1.668.337 2.555.337Z" />
                    </svg>
                    <?php echo e(__('landing.contact_whatsapp')); ?>
...
<?php /**PATH C:\laragon\www\prima-pondok\resources\views/components/contact-section.blade.php ENDPATH**/ ?>